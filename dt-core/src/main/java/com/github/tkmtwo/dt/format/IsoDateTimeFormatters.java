...
public final class IsoDateTimeFormatters {
  ...
  public static final DateTimeFormatter LOCAL_DATETIME_EXTENDED_NOTEE;
  static {
    DateTimeFormatter localDateTimeExtendedNoTee = new DateTimeFormatterBuilder()
      .parseCaseInsensitive()
      .append(LOCAL_DATE_EXTENDED)
      .appendLiteral(' ')
      .append(LOCAL_TIME_EXTENDED)
    ...
    LOCAL_DATETIME_EXTENDED_NOTEE =
      localDateTimeExtendedNoTee
      .withResolverStyle(ResolverStyle.STRICT)
      .withChronology(IsoChronology.INSTANCE)
      .withZone(ZoneId.of("Z"));
  }
  ...
  public static final DateTimeFormatter OFFSET_DATETIME_EXTENDED_NOTEE;
  static {
    DateTimeFormatter offsetDateTimeExtendedNoTee = new DateTimeFormatterBuilder()
      .parseCaseInsensitive()
      .append(LOCAL_DATETIME_EXTENDED_NOTEE)
      .appendOffsetId()
      .toFormatter();
    
    OFFSET_DATETIME_EXTENDED_NOTEE = 
      offsetDateTimeExtendedNoTee
      .withResolverStyle(ResolverStyle.STRICT)
      .withChronology(IsoChronology.INSTANCE)
      .withZone(ZoneId.of("Z"));
  ...
  public static final DateTimeFormatter ZONED_DATETIME_EXTENDED_NOTEE;
  static {
    DateTimeFormatter zonedDateTimeExtendedNoTee = new DateTimeFormatterBuilder()
      .parseCaseInsensitive()
      .append(LOCAL_DATETIME_EXTENDED_NOTEE)
      .appendLiteral(' ')
      .appendZoneId()
    ...
    ZONED_DATETIME_EXTENDED_NOTEE =
      zonedDateTimeExtendedNoTee
      .withResolverStyle(ResolverStyle.STRICT)
      .withChronology(IsoChronology.INSTANCE)
      .withZone(ZoneId.of("Z"));
  ...
  public static final DateTimeFormatter LOCAL_DATETIME_BASIC_NOTEE;
  static {
    DateTimeFormatter localDateTimeBasicNoTee = new DateTimeFormatterBuilder()
      .parseCaseInsensitive()
      .append(LOCAL_DATE_BASIC)
      .appendLiteral(' ')
      .append(LOCAL_TIME_BASIC)
    ...
    LOCAL_DATETIME_BASIC_NOTEE =
      localDateTimeBasicNoTee
      .withResolverStyle(ResolverStyle.STRICT)
      .withChronology(IsoChronology.INSTANCE)
      .withZone(ZoneId.of("Z"));
  }
  ...
  public static final DateTimeFormatter OFFSET_DATETIME_BASIC_NOTEE;
  static {
    DateTimeFormatter offsetDateTimeBasicNoTee = new DateTimeFormatterBuilder()
      .parseCaseInsensitive()
      .append(LOCAL_DATETIME_BASIC_NOTEE)
      .appendOffsetId()
      .toFormatter();
    
    OFFSET_DATETIME_BASIC_NOTEE = 
      offsetDateTimeBasicNoTee
      .withResolverStyle(ResolverStyle.STRICT)
      .withChronology(IsoChronology.INSTANCE)
      .withZone(ZoneId.of("Z"));
  ...
  public static final DateTimeFormatter ZONED_DATETIME_BASIC_NOTEE;
  static {
    DateTimeFormatter zonedDateTimeBasicNoTee = new DateTimeFormatterBuilder()
      .parseCaseInsensitive()
      .append(LOCAL_DATETIME_BASIC_NOTEE)
      .appendLiteral(' ')
      .appendZoneId()
    ...
    ZONED_DATETIME_BASIC_NOTEE =
      zonedDateTimeBasicNoTee
      .withResolverStyle(ResolverStyle.STRICT)
      .withChronology(IsoChronology.INSTANCE)
      .withZone(ZoneId.of("Z"));
